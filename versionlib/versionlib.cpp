...
const char *SOURCEMOD_UPSTREAM = SM_BUILD_UPSTREAM;
const char *SOURCEMOD_UPSTREAM_AHEAD = SM_BUILD_UPSTREAM_AHEAD;
const char *SOURCEMOD_UPSTREAM_SHA = SM_BUILD_UPSTREAM_SHA;
